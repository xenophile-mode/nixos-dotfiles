...
myModMask :: KeyMask
myModMask = mod1Mask        -- Sets modkey to super/windows key  myTerminal :: String
myTerminal = "xterm -b 30"    -- Sets default terminal
...
myKeys =
    ...
    -- Run Prompt
        , ("M1-/", spawn "bash roficonfig") -- Dmenu
    ...
    -- Kill windows
        , ("M1-S-c", kill1)     -- Kill the currently focused client
        , ("M-S-a", killAll)   -- Kill all windows on current workspace

    -- Workspaces
        , ("M1-.", nextScreen)  -- Switch focus to next monitor
        , ("M1-,", prevScreen)  -- Switch focus to prev monitor
    ...
    -- Windows navigation
        ...
        , ("mod1Mask-j", windows W.focusDown)    -- Move focus to the next window
        , ("mod1Mask-k", windows W.focusUp)      -- Move focus to the prev window
    ...
    --    , ("M1-M1-j", sendMessage MirrorShrink)          -- Shrink vert window width
      --  , ("M1-M1-k", sendMessage MirrorExpand)          -- Expand vert window width
